...
- [ ] Chezmoi
  - The dotfiles managed by Chezmoi are stored in a different git repo: `https://github.com/evanharmon1/harmon-dotfiles.git`.
  - `chezmoi init https://github.com/evanharmon1/harmon-dotfiles.git`
