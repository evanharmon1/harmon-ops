#!/bin/sh
# Various CLI commands to modify macOS settings to draw from and put in configureMacSettings.sh
...
defaults write com.apple.finder NewWindowTargetPath -string "file:///Users/evan/"
...
#                               dockutil
#-----------------------------------------------------------------------------
# Most Apple apps need to be pathed from /System/Applications, not /Applications
# Remove all apps from Dock so I can add what I want in order
dockutil --remove all
...
#                               Manual Safari
#-----------------------------------------------------------------------------
# - Change Safari Downloads to ~/Dropbox/Devices/Downloads
...
defaults write org.m0k.transmission IncompleteDownloadFolder -string "${HOME}/Local/TorrentsIncomplete"
defaults write org.m0k.transmission DownloadFolder -string "${HOME}/Dropbox/Devices/Downloads/ Torrents"
...
#============================================================================
#                       Set Default Application for File Types with duti Tool
#============================================================================
...
duti -s com.microsoft.VSCode ts
duti -s com.microsoft.VSCode java
duti -s com.microsoft.VSCode go
duti -s com.microsoft.VSCode sh
duti -s com.microsoft.VSCode html
duti -s com.microsoft.VSCode css
duti -s com.microsoft.VSCode dart
duti -s com.microsoft.VSCode zsh
duti -s com.microsoft.VSCode bash
duti -s com.microsoft.VSCode php
duti -s com.microsoft.VSCode code-workspace

# Set IINA for .mov and .mkv files
duti -s com.colliderli.iina mov
duti -s com.colliderli.iina mkv

# Set Folding Text for markdown files
# duti -s whatevertyporamightbe md

# Set Pages for doc files
duti -s com.apple.iWork.Pages doc

# Set Nova for plist files (untested)
# duti -s com.apple.property-list doc
...
echo -e "\033[1;32m  Note that some of these changes require a logout/restart to take effect.  \033[0m"
