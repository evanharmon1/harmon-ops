...
# Author: Evan Harmon
# Sourced from: https://betterdev.blog/minimal-safe-bash-script-template/
...
# Optional Simple Parse CLI input
if [ $# -eq 0 ]; then
  echo "usage: shellTemplate 'input1' 'input2'"
  exit 0
...
# script logic here - call the main() function
